            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='chongwulingyang'">
                    <el-form-item class="select" v-if="type!='info'"  label="宠物领养" prop="chongwulingyangId">
                        <el-select v-model="ruleForm.chongwulingyangId" filterable placeholder="请选择宠物领养" @change="chongwulingyangChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='chongwulingyang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="类型" prop="chongwulingyangValue">
                        <el-input v-model="chongwulingyangForm.chongwulingyangValue"
                ...
                <el-col :span="24" v-if="sessionTable !='chongwulingyang' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='chongwulingyang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="是否被认领" prop="jieshuValue">
                        <el-input v-model="chongwulingyangForm.jieshuValue"
                                  placeholder="是否被认领" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='chongwulingyangId'){
                          this.ruleForm.chongwulingyangId = obj[o];
                          this.ro.chongwulingyangId = true;
                          continue;
                      }
                      if(o=='yonghuId'){
                      ...
                      if(o=='chongwulingyangshenheYesnoTypes'){
                          this.ruleForm.chongwulingyangshenheYesnoTypes = obj[o];
                          this.ro.chongwulingyangshenheYesnoTypes = true;
                          continue;
                      }
                    }
                }
            ...
            info(id) {
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.chongwulingyangChange(data.data.chongwulingyangId)
