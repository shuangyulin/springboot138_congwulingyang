...
public class JiaoxueshipinLiuyanView extends JiaoxueshipinLiuyanEntity implements Serializable {
	...
	public JiaoxueshipinLiuyanView() {

	}

	public JiaoxueshipinLiuyanView(JiaoxueshipinLiuyanEntity jiaoxueshipinLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, jiaoxueshipinLiuyanEntity);
